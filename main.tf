module "ec2_instance" {
  ...
  root_block_device                    = [merge({ "kms_key_id" = var.kms_key_id }, var.root_block_device)]
  ...
  iam_role_policies = var.ssm_policy_enabled ? merge(
  { "AmazonSSMManagedInstanceCore" : "arn:aws:iam::aws:policy/AmazonSSMManagedInstanceCore" }, var.iam_role_policies) : var.iam_role_policies
